                                                    ...
                                                    <div class="col-12">
                                                        <div style="width: 100%;">
                                                            ...
                                                            <textarea name="infoSekolah"
                                                                id="editorKeteranganEdit"><?= $d['keterangan'] ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <form method="POST" action="TambahGaleri" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="col-12">
                        <div style="width: 100%;">
                            <label class="form-label">Keterangan</label>
                            <textarea name="infoSekolah" id="editorKeterangan"></textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <label class="form-label">Gambar</label>
...
ClassicEditor
    .create(document.querySelector('#editorKeterangan'), {
...
ClassicEditor
    .create(document.querySelector('#editorKeteranganEdit'), {
        plugins: [Essentials, Paragraph, Bold, Italic, Font],
        toolbar: [
            'undo', 'redo', '|', 'bold', 'italic', '|',
            'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor'
