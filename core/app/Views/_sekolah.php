...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Data Struktur Organisasi Sekolah</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Dashboard_">Dashboard</a></li>
        <li class="breadcrumb-item active">Data Struktur Organisasi Sekolah</li>
      </ol>
      <a data-bs-toggle="modal" data-bs-target="#modalTambahUser"><button type="button" class="btn btn-primary"><i
          ...
          Struktur Organisasi Sekolah</button></a>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Table Data Struktur Organisasi Sekolah</h5>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a data-bs-toggle="modal" data-bs-target="#modalEdit<?= $d['idSekolah'] ?>"><i
                          class="bi bi-pencil"></i></a>&nbsp;
                      <a data-bs-toggle="modal"
                        data-bs-target="#modalGantiFoto<?= $d['idSekolah'] ?>"><i
                          class="bi bi-images"></i></a>&nbsp;
                      <a data-bs-toggle="modal"
                        data-bs-target="#modalValidasiHapus<?= $d['idSekolah'] ?>"><i
                          class="bi bi-trash-fill"></i></a>&nbsp;
                    </td>
                  </tr>
                  <!-- Modal Edit Data -->
                  <div class="modal fade" id="modalEdit<?= $d['idSekolah'] ?>" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        ...
                        <form method="POST" action="EditOrganisasiSekolah/<?= $d['idSekolah'] ?>"
                  ...
                  <!-- Modal Ganti Gambar -->
                  <div class="modal fade" id="modalGantiFoto<?= $d['idSekolah'] ?>" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form method="POST"
                          action="GantiFotoOrganisasiSekolah/<?= $d['idSekolah'] ?>"
                          enctype="multipart/form-data">
                          <div class="modal-body">
                            <div class="col-12">
                  ...
                  <div class="modal fade" id="modalValidasiHapus<?= $d['idSekolah'] ?>" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                          <a
                            href="<?= base_url() ?>HapusOrganisasiSekolah/<?= $d['idSekolah'] ?>"><button
...
<div class="modal fade" id="modalTambahUser" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form method="POST" action="TambahOrganisasiSekolah" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="col-12">
            <label class="form-label">Nama</label>
            <div class="input-group has-validation">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary">
            Tambah Struktur Organisasi Sekolah</button>
        </div>
      </form>
    </div>
  </div>
