...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Data Struktur Organisasi Tenaga Pendidik</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Dashboard_">Dashboard</a></li>
        <li class="breadcrumb-item active">Data Struktur Organisasi Tenaga Pendidik</li>
      </ol>
      <a data-bs-toggle="modal" data-bs-target="#modalTambahUser"><button type="button" class="btn btn-primary"><i
          ...
          Struktur Organisasi Pendidik</button></a>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Table Data Struktur Organisasi Tenaga Pendidik</h5>
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a data-bs-toggle="modal"
                        data-bs-target="#modalEdit<?= $d['idTenagaPendidik'] ?>"><i
                  ...
                  <!-- Modal Ganti Gambar -->
                  <div class="modal fade" id="modalGantiFoto<?= $d['idTenagaPendidik'] ?>" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form method="POST"
                          action="GantiFotoOrganisasiPendidik/<?= $d['idTenagaPendidik'] ?>"
                          enctype="multipart/form-data">
                          <div class="modal-body">
                            <div class="col-12">
                  ...
                  <div class="modal fade" id="modalValidasiHapus<?= $d['idTenagaPendidik'] ?>"
                    tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                          <a
                            href="<?= base_url() ?>HapusOrganisasiPendidik/<?= $d['idTenagaPendidik'] ?>"><button
