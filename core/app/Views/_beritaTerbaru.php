            ...
            <div class="col-lg-12">
                ...
                ?>
                                <tr>
                                    ...
                                    <td>
                                        <a data-bs-toggle="modal" data-bs-target="#modalDetail<?= $d['idBerita'] ?>"><i
                                                class="bi bi-eye"></i></a>&nbsp;
                                ...
                                <!-- Modal Edit Data -->
                                <div class="modal fade" id="modalDetail<?= $d['idBerita'] ?>" tabindex="-1">
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <label class="form-label"><?= $d['berita'] ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                            </form>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div>
                                                                <textarea name="berita" class="form-control"
                                                                    id="editorBeritaEdit"
                                                                    style="width: 100%;"><?= $d['berita'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <label class="form-label">Berita</label>
                            <div style="width: 100%;">
                                <textarea name="berita" id="editorBerita"></textarea>
                            </div>
                        </div>
...
ClassicEditor
    .create(document.querySelector('#editorBeritaEdit'), {
        plugins: [Essentials, Paragraph, Bold, Italic, Font],
        toolbar: [
            'undo', 'redo', '|', 'bold', 'italic', '|',
            'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor'
