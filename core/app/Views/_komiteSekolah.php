...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Data Struktur Organisasi Komite Sekolah</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Dashboard_">Dashboard</a></li>
        <li class="breadcrumb-item active">Data Struktur Organisasi Komite Sekolah</li>
      </ol>
      <a data-bs-toggle="modal" data-bs-target="#modalTambahUser"><button type="button" class="btn btn-primary"><i
          ...
          Struktur Organisasi Komite Sekolah</button></a>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Table Data Struktur Organisasi Komite Sekolah</h5>
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a data-bs-toggle="modal"
                        data-bs-target="#modalEdit<?= $d['idKomiteSekolah'] ?>"><i
                          class="bi bi-pencil"></i></a>&nbsp;
                      <a data-bs-toggle="modal"
                        data-bs-target="#modalGantiFoto<?= $d['idKomiteSekolah'] ?>"><i
                          class="bi bi-images"></i></a>&nbsp;
                      <a data-bs-toggle="modal"
                        data-bs-target="#modalValidasiHapus<?= $d['idKomiteSekolah'] ?>"><i
                          class="bi bi-trash-fill"></i></a>&nbsp;
                    </td>
                  </tr>
                  <!-- Modal Edit Data -->
                  <div class="modal fade" id="modalEdit<?= $d['idKomiteSekolah'] ?>" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        ...
                        <form method="POST"
                          action="EditOrganisasiKomiteSekolah/<?= $d['idKomiteSekolah'] ?>"
                  ...
                  <!-- Modal Ganti Gambar -->
                  <div class="modal fade" id="modalGantiFoto<?= $d['idKomiteSekolah'] ?>" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form method="POST"
                          action="GantiFotoOrganisasiKomiteSekolah/<?= $d['idKomiteSekolah'] ?>"
                          enctype="multipart/form-data">
                          <div class="modal-body">
                            <div class="col-12">
                  ...
                  <div class="modal fade" id="modalValidasiHapus<?= $d['idKomiteSekolah'] ?>"
                    tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                          <a
                            href="<?= base_url() ?>HapusOrganisasiKomiteSekolah/<?= $d['idKomiteSekolah'] ?>"><button
...
<div class="modal fade" id="modalTambahUser" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form method="POST" action="TambahOrganisasiKomiteSekolah" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="col-12">
            <label class="form-label">Nama</label>
            <div class="input-group has-validation">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary">
            Tambah Struktur Organisasi Komite Sekolah</button>
        </div>
      </form>
    </div>
  </div>
